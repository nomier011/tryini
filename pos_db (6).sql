...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 13, 2026 at 12:25 PM
...
CREATE TABLE `cancelled_orders` (
  ...
  `payment_method` enum('cash','card','online','gcash','maya','paymongo') DEFAULT NULL,
...
(12, 13, '2026-04-13 09:39:25', '2026-04-13 09:41:10'),
(13, 20, '2026-04-13 09:48:14', '2026-04-13 09:53:42'),
(14, 20, '2026-04-13 09:54:28', '2026-04-13 10:24:26'),
(15, 20, '2026-04-13 10:24:48', NULL);
...
CREATE TABLE `orders` (
  ...
  `customer_name` varchar(100) DEFAULT NULL,
  `total_amount` decimal(10,2) NOT NULL,
  `payment_method` enum('cash','card','online','gcash','maya','paymongo') DEFAULT 'cash',
  `payment_status` enum('paid','unpaid','refunded') DEFAULT 'paid',
  `order_status` enum('pending','preparing','served','cancelled','pending_payment') DEFAULT 'pending',
...
(7, 'ORD-20260413-0001', 13, '', 290.00, 'paymongo', 'paid', 'pending_payment', 0, NULL, NULL, NULL, NULL, NULL, '2026-04-13 09:40:04', '2026-04-13 09:40:04'),
(8, 'ORD-20260413-0002', 13, '', 160.00, 'gcash', 'paid', 'pending', 0, NULL, NULL, NULL, NULL, NULL, '2026-04-13 09:40:34', NULL),
(9, 'ORD-20260413-0003', 13, '', 240.00, 'card', 'paid', 'pending', 0, NULL, NULL, NULL, NULL, NULL, '2026-04-13 09:40:54', NULL),
(10, 'ORD-20260413-0004', 20, '', 190.00, 'gcash', 'paid', 'pending', 0, NULL, NULL, NULL, NULL, NULL, '2026-04-13 09:48:38', NULL),
(11, 'ORD-20260413-0005', 20, '', 290.00, 'paymongo', 'paid', 'pending_payment', 0, NULL, NULL, NULL, NULL, NULL, '2026-04-13 09:58:48', NULL),
(12, 'ORD-20260413-0006', 20, 'DARWIN', 165.00, 'card', 'paid', 'pending', 0, NULL, NULL, NULL, NULL, NULL, '2026-04-13 09:59:03', NULL),
(13, 'ORD-20260413-0007', 20, '', 315.00, 'cash', 'paid', 'pending', 0, NULL, NULL, NULL, NULL, NULL, '2026-04-13 09:59:49', NULL);
...
(29, 7, 11, 1, 110.00, 110.00, ''),
(30, 7, 20, 1, 95.00, 95.00, ''),
(31, 7, 3, 1, 85.00, 85.00, ''),
(32, 8, 2, 1, 75.00, 75.00, ''),
(33, 8, 16, 1, 85.00, 85.00, ''),
(34, 9, 2, 1, 75.00, 75.00, ''),
(35, 9, 4, 1, 85.00, 85.00, ''),
(36, 9, 14, 1, 80.00, 80.00, ''),
(37, 10, 14, 1, 80.00, 80.00, ''),
(38, 10, 7, 1, 110.00, 110.00, ''),
(39, 11, 44, 1, 160.00, 160.00, ''),
(40, 11, 54, 2, 65.00, 130.00, ''),
(41, 12, 4, 1, 85.00, 85.00, ''),
(42, 12, 14, 1, 80.00, 80.00, ''),
(43, 13, 7, 1, 110.00, 110.00, ''),
(44, 13, 17, 1, 110.00, 110.00, ''),
(45, 13, 15, 1, 95.00, 95.00, '');
...
(2, 'Americano', 'Espresso with hot water, smooth and bold', 75.00, 'drinks', 'Hot Coffee', 'drinks/1772442298_69a552ba15bfe.jpg', 98, 1, '2026-02-20 18:29:02', '2026-04-13 09:40:54'),
(3, 'Latte', 'Espresso with steamed milk, creamy and smooth', 85.00, 'drinks', 'Hot Coffee', 'drinks/1772442456_69a55358b8c04.jpg', 99, 1, '2026-02-20 18:29:02', '2026-04-13 09:40:04'),
(4, 'Cappuccino', 'Espresso with foamed milk, rich and frothy', 85.00, 'drinks', 'Hot Coffee', 'drinks/1772442285_69a552ad30b83.jpg', 97, 1, '2026-02-20 18:29:02', '2026-04-13 09:59:03'),
...
(7, 'Vanilla Latte', 'Latte with vanilla syrup, smooth and aromatic', 110.00, 'drinks', 'Specialty Coffee', 'drinks/1772442682_69a5543ad9ed4.jpg', 98, 1, '2026-02-20 18:29:02', '2026-04-13 09:59:49'),
...
(11, 'Iced Caramel Latte', 'Iced latte with caramel syrup, sweet and cool', 110.00, 'drinks', 'Cold Coffee', 'drinks/1772442036_69a551b47fe7e.jpg', 99, 1, '2026-02-20 18:29:02', '2026-04-13 09:40:04'),
...
(14, 'Hot Chocolate', 'Rich hot chocolate with marshmallows', 80.00, 'drinks', 'Non-Coffee', 'drinks/1772442501_69a553853e764.jpg', 96, 1, '2026-02-20 18:29:02', '2026-04-13 09:59:03'),
(15, 'Matcha Latte', 'Green tea latte, earthy and creamy', 95.00, 'drinks', 'Non-Coffee', 'drinks/1772442510_69a5538ed617a.jpg', 99, 1, '2026-02-20 18:29:02', '2026-04-13 09:59:49'),
(16, 'Chai Tea Latte', 'Spiced tea latte with milk', 85.00, 'drinks', 'Non-Coffee', 'drinks/1772442484_69a553749fad5.jpg', 97, 1, '2026-02-20 18:29:02', '2026-04-13 09:40:34'),
(17, 'White Chocolate Mocha', 'White chocolate and espresso, sweet and creamy', 110.00, 'drinks', 'Non-Coffee', 'drinks/1772442622_69a553fecfcf3.jpg', 99, 1, '2026-02-20 18:29:02', '2026-04-13 09:59:49'),
...
(20, 'Strawberry Smoothie', 'Fresh strawberries blended with yogurt', 95.00, 'drinks', 'Fruit Drinks', 'drinks/1772442444_69a5534c7a305.jpg', 99, 1, '2026-02-20 18:29:02', '2026-04-13 09:40:04'),
...
(44, 'Beef Tapa', 'Marinated beef tapa with garlic rice and egg', 160.00, 'foods', 'Rice Meals', 'foods/1772444538_69a55b7a30b8d.jpg', 34, 1, '2026-02-20 18:29:02', '2026-04-13 09:58:48'),
...
(54, 'Brownie', 'Fudgy chocolate brownie with walnuts', 65.00, 'foods', 'Desserts', 'foods/1772444443_69a55b1b231f2.jpg', 42, 1, '2026-02-20 18:29:02', '2026-04-13 09:58:48'),
...
(1, 'admin', 'admin@coffee.com', '$2y$10$YourHashHere', 'manager', '2026-02-20 18:29:02', '2026-03-02 09:46:13', NULL, 1, NULL, NULL),
...
(6, 'ME', 'Darwin@gmail.com', '$2y$10$F42xMWItPH9/C.w0PviyouIO43fwte3qY.7fGIB7lB7USzv6NvyOS', 'cashier', '2026-03-02 08:22:22', '2026-03-02 09:22:50', NULL, 1, 1, '2026-03-02 08:25:57'),
...
(13, 'cashier1', 'cashier@coffee.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'manager', '2026-04-13 09:17:02', '2026-04-13 10:24:37', '2026-04-13 09:41:10', 1, NULL, NULL),
(16, 'cashier2', 'cashier2@coffee.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'cashier', '2026-04-13 09:21:29', NULL, NULL, 1, NULL, NULL),
(20, 'Darwin', 'manubag859@gmail.com', '$2y$10$KturEujX8Qkk.2S0i2nGFesS1GmolV1c0dsrD49OxAApG2VEpyv1C', 'cashier', '2026-04-13 09:47:50', '2026-04-13 10:24:48', '2026-04-13 10:24:26', 1, NULL, NULL);
